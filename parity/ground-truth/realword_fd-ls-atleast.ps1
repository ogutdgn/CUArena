# Paragraph dialog: Line spacing At least ground truth via COM (generated). SAFE ONLY WHEN NO OTHER WORD IS OPEN.
...
try {
    ...
    $r.ParagraphFormat.LineSpacingRule = 3; $r.ParagraphFormat.LineSpacing = 12
