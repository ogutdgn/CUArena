# Real-Word bold ground truth via COM. SAFE ONLY WHEN NO OTHER WORD IS OPEN
# (New-Object Word.Application can attach to a running instance; Quit would close it).
