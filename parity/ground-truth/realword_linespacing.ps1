# Real-Word line-spacing ground truth via COM (ParagraphFormat.LineSpacingRule == ribbon
# Line & Paragraph Spacing -> 2.0). SAFE ONLY WHEN NO OTHER WORD IS OPEN (Quit would close it).
...
try {
    ...
    $r.ParagraphFormat.LineSpacingRule = 2   # wdLineSpaceDouble -> <w:spacing w:line="480" w:lineRule="auto">
