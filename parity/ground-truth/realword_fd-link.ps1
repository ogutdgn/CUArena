# Insert Hyperlink (text + address) ground truth via COM (generated). SAFE ONLY WHEN NO OTHER WORD IS OPEN.
...
try {
    ...
    $null = $r.Hyperlinks.Add($r, 'https://example.com', $null, $null, 'Revenue')
