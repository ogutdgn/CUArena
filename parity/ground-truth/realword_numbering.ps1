# Real-Word numbering ground truth via COM. NOTE: like bullets/table, ListFormat.ApplyNumberDefault()
# is the COM equivalent of the ribbon "Numbering" button; COM may differ from the ribbon's exact list
# template in numbering.xml (out of the differ's document.xml scope today). SAFE ONLY WHEN NO OTHER WORD IS OPEN.
