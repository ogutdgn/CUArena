# Paragraph dialog: Line spacing Multiple ground truth via COM (generated). SAFE ONLY WHEN NO OTHER WORD IS OPEN.
...
try {
    ...
    $r.ParagraphFormat.LineSpacingRule = 5; $r.ParagraphFormat.LineSpacing = 13.8
