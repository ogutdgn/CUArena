# Paragraph dialog: Line spacing Exactly ground truth via COM (generated). SAFE ONLY WHEN NO OTHER WORD IS OPEN.
...
try {
    ...
    $r.ParagraphFormat.LineSpacingRule = 4; $r.ParagraphFormat.LineSpacing = 12
