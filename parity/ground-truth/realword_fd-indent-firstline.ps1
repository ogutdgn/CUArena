# Paragraph dialog: First-line indent ground truth via COM (generated). SAFE ONLY WHEN NO OTHER WORD IS OPEN.
...
try {
    ...
    $r.ParagraphFormat.FirstLineIndent = $w.InchesToPoints(0.5)
