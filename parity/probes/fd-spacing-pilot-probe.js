/* Font dialog (Advanced): Character spacing — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-spacing.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { letterSpacing: '1pt' }); await sleep(130);
