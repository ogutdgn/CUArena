/* Paragraph dialog: Keep lines together — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-pag-keeplines.docx';
  ...
  try {
    ...
    PM.cmd('updateAttributes', 'paragraph', { 'paragraphProperties.keepLines': true }); await sleep(130);
