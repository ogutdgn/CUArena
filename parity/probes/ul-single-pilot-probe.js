/* Underline single variation — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-ul-single.docx';
  ...
  try {
    ...
    PM.chain([['setUnderline'], ['setMark', 'underline', { underlineType: 'single' }]]); await sleep(110);
