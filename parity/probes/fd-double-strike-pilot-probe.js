/* Font dialog: Double strikethrough — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-double-strike.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { dstrike: true }); await sleep(130);
