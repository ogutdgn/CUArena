/* Text Highlight task — clone side. Type "Revenue", select it, apply yellow highlight, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-highlight.docx';
  ...
  try {
    ...
    PM.cmd('setHighlight', '#FFFF00'); await sleep(80);
