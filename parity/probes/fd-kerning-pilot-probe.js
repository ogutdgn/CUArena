/* Font dialog (Advanced): Kerning >= 8pt — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-kerning.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { kern: 16 }); await sleep(130);
