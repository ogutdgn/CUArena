/* Underline words-only — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  try {
    ...
    PM.chain([['setUnderline'], ['setMark', 'underline', { underlineType: 'words' }]]); await sleep(130);
