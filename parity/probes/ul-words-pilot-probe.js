/* Underline words-only variation — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-ul-words.docx';
  ...
  try {
    ...
    PM.chain([['setUnderline'], ['setMark', 'underline', { underlineType: 'words' }]]); await sleep(110);
