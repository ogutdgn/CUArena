/* Paragraph dialog: Keep with next — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-pag-keepnext.docx';
  ...
  try {
    ...
    PM.cmd('updateAttributes', 'paragraph', { 'paragraphProperties.keepNext': true }); await sleep(130);
