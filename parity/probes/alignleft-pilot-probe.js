/* Align Left task — clone side. Type "Revenue", select it, set paragraph align left, export docx.
   NOTE: the clone writes an EXPLICIT left justification; Word omits jc for left (its default) —
   the differ surfaces that asymmetry as a real finding. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-alignleft.docx';
  ...
  try {
    ...
    PM.cmd('setTextAlign', 'left'); await sleep(80);
