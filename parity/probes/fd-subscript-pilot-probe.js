/* Font dialog: Subscript — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-subscript.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { vertAlign: 'subscript' }); await sleep(130);
