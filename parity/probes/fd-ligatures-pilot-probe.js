/* Font dialog (Advanced): Ligatures (OpenType) — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-ligatures.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { fontVariantLigatures: 'common-ligatures' }); await sleep(130);
