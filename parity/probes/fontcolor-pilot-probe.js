/* Font Color task — clone side. Type "Revenue", select it, set color red, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fontcolor.docx';
  ...
  try {
    ...
    PM.cmd('setColor', '#FF0000'); await sleep(80);
