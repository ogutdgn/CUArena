/* Font dialog (Advanced): Character scale — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-scale.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { w: 150 }); await sleep(130);
