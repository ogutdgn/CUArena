/* Line spacing 1.0 variation — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-ls-1p0.docx';
  ...
  try {
    ...
    PM.cmd('setLineHeight', 1); await sleep(110);
