/* Font dialog: Small caps — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-smallcaps.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { smallCaps: true }); await sleep(130);
