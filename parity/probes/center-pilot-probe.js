/* Center task — clone side. Type "Revenue", select it, set paragraph align center, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-center.docx';
  ...
  try {
    ...
    PM.cmd('setTextAlign', 'center'); await sleep(80);
