/* Bullets task — clone side. Type "Revenue", select it, apply a default bullet list, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-bullets.docx';
