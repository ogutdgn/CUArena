/* Font dialog: Strikethrough — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-strike.docx';
  ...
  try {
    ...
    PM.cmd('setStrike'); await sleep(130);
