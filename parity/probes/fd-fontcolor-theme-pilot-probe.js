/* Font color: THEME color (Accent 2) — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-fontcolor-theme.docx';
  ...
  try {
    ...
    PM.cmd('setColor', '#E97132', { themeColor: 'accent2' }); await sleep(130);
