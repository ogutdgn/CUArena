/* Page Setup: Left margin 1.5in — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-margin-left.docx';
  ...
  try {
    ...
    PM.dePageMargins({ top: 1, right: 1, bottom: 1, left: 1.5 }); await sleep(130);
