/* Paragraph dialog: Line spacing At least — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-ls-atleast.docx';
  ...
  try {
    ...
    PM.cmd('updateAttributes', 'paragraph', { 'paragraphProperties.spacing.line': 240, 'paragraphProperties.spacing.lineRule': 'atLeast' }); await sleep(130);
