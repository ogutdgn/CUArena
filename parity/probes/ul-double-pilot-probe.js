/* Underline double variation — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-ul-double.docx';
  ...
  try {
    ...
    PM.chain([['setUnderline'], ['setMark', 'underline', { underlineType: 'double' }]]); await sleep(110);
