/* Justify task — clone side. Type "Revenue", select it, set paragraph alignment justified, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-justify.docx';
  ...
  try {
    ...
    PM.cmd('setTextAlign', 'justify'); await sleep(80);
