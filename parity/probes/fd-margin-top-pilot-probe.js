/* Page Setup: Top margin 1.25in — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-margin-top.docx';
  ...
  try {
    ...
    PM.dePageMargins({ top: 1.25, right: 1, bottom: 1, left: 1 }); await sleep(130);
