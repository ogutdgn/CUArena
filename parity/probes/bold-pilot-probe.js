/* Bold task — clone side. Type "Revenue", select it, toggleBold, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-bold.docx';
  ...
  try {
    ...
    PM.cmd('toggleBold'); await sleep(80);
