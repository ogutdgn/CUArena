/* Font dialog: All caps — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-allcaps.docx';
  ...
  try {
    ...
    PM.cmd('setMark', 'textStyle', { textTransform: 'uppercase' }); await sleep(130);
