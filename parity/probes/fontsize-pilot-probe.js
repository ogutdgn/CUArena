/* Font size task — clone side. Type "Revenue", select it, set size 14pt, export docx.
   Uses PM.setFontSizePt (Word's 1–1638pt range), NOT PM.cmd('setFontSize') which clamps 8–96. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fontsize.docx';
  ...
  try {
    ...
    PM.setFontSizePt(14); await sleep(80);
