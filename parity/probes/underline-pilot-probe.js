/* Underline task — clone side. Type "Revenue", select it, toggleUnderline (single), export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-underline.docx';
  ...
  try {
    ...
    PM.cmd('toggleUnderline'); await sleep(80);
