/* Line Spacing task — clone side. Type "Revenue", select it, set line spacing 2.0 (double), export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-linespacing.docx';
  ...
  try {
    ...
    PM.cmd('setLineHeight', 2); await sleep(80);
