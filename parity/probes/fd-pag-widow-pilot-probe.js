/* Paragraph dialog: Widow/Orphan control off — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-pag-widow.docx';
  ...
  try {
    ...
    PM.cmd('updateAttributes', 'paragraph', { 'paragraphProperties.widowControl': false }); await sleep(130);
