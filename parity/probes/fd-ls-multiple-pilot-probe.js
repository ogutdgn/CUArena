/* Paragraph dialog: Line spacing Multiple — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-ls-multiple.docx';
  ...
  try {
    ...
    PM.cmd('setLineHeight', 1.15); await sleep(130);
