/* Italic task — clone side. Type "Revenue", select it, toggleItalic, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-italic.docx';
  ...
  try {
    ...
    PM.cmd('toggleItalic'); await sleep(80);
