/* Font dialog: Underline color — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-underline-color.docx';
  ...
  try {
    ...
    PM.cmd('setUnderline'); PM.cmd('setMark', 'underline', { underlineColor: '#FF0000' }); await sleep(130);
