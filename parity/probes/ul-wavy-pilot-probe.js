/* Underline wavy — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  try {
    ...
    PM.chain([['setUnderline'], ['setMark', 'underline', { underlineType: 'wave' }]]); await sleep(130);
