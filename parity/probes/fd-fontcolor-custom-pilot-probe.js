/* Font color: custom RGB (More Colors) — clone side (generated by parity/tools/gen_tasks.py). Apply to "Revenue", export. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fd-fontcolor-custom.docx';
  ...
  try {
    ...
    PM.cmd('setColor', '#3A7BD5'); await sleep(130);
