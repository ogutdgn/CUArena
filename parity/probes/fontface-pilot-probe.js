/* Font face task — clone side. Type "Revenue", select it, set font family Arial, export docx. */
(async () => {
  ...
  const OUT = 'C:/Users/ogutd/OneDrive/Desktop/new-coding/ms-word-clone/parity/fixtures/wc-fontface.docx';
  ...
  try {
    ...
    PM.cmd('setFontFamily', 'Arial'); await sleep(80);
