...
## Notes / gaps
- Figma-HTML clipboard format: see `helper/open-source-example/open-pencil/packages/core/src/editor/clipboard.ts` for reference on producing a Figma-compatible clipboard payload.
