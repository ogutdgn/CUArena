...
task = Task(
    ...
    rubrics=[
        ...
        # critical: prompt-explicit corner radius + right-edge positioning + circular thumb
        AlignmentRubric([
            CornerRadiusAtLeast(layer_type="rectangle", min_value=15.0),                     # 0 ★ prompt: "radius 999"
            LayerEdgesAligned(type_a="ellipse", edge_a="right",                              # 1 ★ prompt: "2px from the right edge"
