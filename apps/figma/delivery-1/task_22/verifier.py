...
task = Task(
    ...
    rubrics=[
        ...
        AlignmentRubric([
            LayersSameDimensions(layer_type="rectangle", tolerance=25.0),          # 0 ★ prompt: "same-size"
            LayersAligned(layer_type="rectangle", axis="center_y", tolerance=25.0),# 1 ★ prompt: "same y-baseline"
            LayersStacked(layer_type="rectangle", axis="x", gap_px=8.0, tolerance=25.0),  # 2 ★ prompt: "horizontal row"
