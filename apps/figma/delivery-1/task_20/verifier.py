...
Dark navy frame + 2 overlapping bright-colored circles (e.g., magenta + cyan).
"""
...
from verifier.checks.geometry_checks import (
    LayersOverlap, AllLayersAreCircular,
    AllLayerBoundsInside, LayerSizeAtLeast, FrameCountAtMost,
    LayerRotationEquals, LayersSameDimensions, LayersHaveDistinctCenters,
)
from verifier.checks.fill_checks   import (
    AllFillTypeIs, SolidColorEquals, DistinctTypedSolidColors,
    FillCountAtMost,
)
...
task = Task(
    ...
    rubrics=[
        FundamentalsRubric([
            ShapeCountAtLeast("frame", minimum=1),                                      # 0 ★ prompt: "dark navy frame"
            ShapeCount("ellipse", equals=2),                                            # 1 ★ prompt: "2 overlapping ... circles"
        ...
        ColorRubric([
            ...
            DistinctTypedSolidColors(layer_type="ellipse", minimum=2, tolerance=0.12),  # 5 ★ prompt: "different bright colors"
