...
from verifier.checks.geometry_checks import LayersConcentric, LayersStrictlyNested, LayerAllSquare
...
task = Task(
    ...
    rubrics=[
        FundamentalsRubric([
            ...
            LayerAllSquare(layer_type="rectangle", tolerance=4.0),
        ], weight=0.25, critical=[0, 1]),

        AlignmentRubric([
            LayersConcentric(layer_type="rectangle", tolerance=8.0),
            LayersStrictlyNested(layer_type="rectangle", equals=4, tolerance_px=8.0, min_size_drop_px=8.0),
        ], weight=0.25, critical=[0, 1]),
