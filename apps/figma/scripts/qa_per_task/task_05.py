"""Task 05 — Plus sign from 2 perpendicular rectangles centered together (red)."""
...
def _plus_log(h_size=(200, 60), v_size=(60, 200), color=RED, hx_offset=0, hy_offset=0):
    ...
    v_rect = make_layer("rectangle",
                        ...
                        w=v_size[0], h=v_size[1], fill=color)
...
def fail_wrong_color():           return _plus_log(color=BLUE)
