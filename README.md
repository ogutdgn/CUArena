...
│                       (active — real binary, no verifier yet)
...
- **Working on the libreoffice app?** → [apps/libreoffice/CLAUDE.md](apps/libreoffice/CLAUDE.md), [apps/libreoffice/docs/architecture/ROADMAP.md](apps/libreoffice/docs/architecture/ROADMAP.md), [apps/libreoffice/docs/USAGE.md](apps/libreoffice/docs/USAGE.md)
