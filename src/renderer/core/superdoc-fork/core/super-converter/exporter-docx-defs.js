...
export const DEFAULT_LINKED_STYLES = {
  ...
  // MS-WORD-CLONE FORK EDIT (parity 030, user-authorized, DATA-ONLY): the cached literal
  // border/fill hexes below were the LEGACY 2013 palette (4472C4/8EAADB/D9E2F3) while the
  // paired themeColor refs say accent1 — and the renderer prefers literals
  // (application.ts resolveColorFromAttributes), so the fallback def painted the wrong
  // palette. Values replaced with the locked-build capture (parity/oracle/
  // table_style_defs.json GridTable4-Accent1: 156082/45B0E1/C1E4F5). No logic changes.
  'GridTable4-Accent1': {
    type: 'element',
    name: 'w:style',
    attributes: {
