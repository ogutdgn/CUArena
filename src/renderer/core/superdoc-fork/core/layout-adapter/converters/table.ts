...
// MS-WORD-CLONE FORK EDIT (parity 032, user-authorized): border-collapse thicker-wins paint (archive 47488c0)
...
// behavior (the pre-existing gap, never a regression). Width-only thicker-wins per the LO note
// simplification (style-rank multiplier + dotted-fixed-weight are a documented follow-up).
