...
SUFFIX_SUB = {
    ...
    # Cell Size value fields (Spinner leaves, newly captured in word-4tabs-v1 after Spinner was
    # added to the INTERACTIVE set) — the row-height / column-width fields the More/Less
    # steppers also drive; same capability
    "table-row-height": "subfeature:table-cell-size",
    "table-column-width": "subfeature:table-cell-size",
    ...
    # Header/Footer position distance value fields (Spinner leaves, newly captured in
    # word-4tabs-v1) — the "Header from Top" / "Footer from Bottom" fields the steppers drive
    "header-footer-position-header-from-top": "subfeature:hf-position",
    "header-footer-position-footer-from-bottom": "subfeature:hf-position",
    # shared: object-arrange
    ...
    # object Height / Width value fields (Spinner leaves, newly captured in word-4tabs-v1) —
    # the size fields the More/Less steppers drive; same capability
    "shape-height": "subfeature:object-size",
    "shape-width": "subfeature:object-size",
